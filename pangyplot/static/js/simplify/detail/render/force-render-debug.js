// Debug overlay for force vectors, chain centroids, perpendiculars, and node state.
// Toggled by Y key (state.forceVectors), cycled by U key (state.forceVectorMode).

import { state } from '../../simplify-state.js';
import { computeForceDeltas, linkStrength, linkDistance, chargeMaxDist } from '../engines/force-engine.js';
