// SVG and PNG export for the viewer.
// Replicates the export pattern: runs the same rendering pipeline
...
import { setSvgTransform, clearSvgTransform } from './svg-utils.js';
