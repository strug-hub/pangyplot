...
PangyPlot uses the `D3 Force Graph library <https://github.com/vasturiano/force-graph>`_ to draw the graph representation.
...
PangyPlot splits up longer segments into a series of connected D3 nodes, using thickly drawn links to give the illusion of length. 
